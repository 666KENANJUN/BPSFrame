...
namespace BPSFrame.Editor
{
    public class PoolSystemViewer : EditorWindow
    {
        ...
        [MenuItem("BPSFrame/PoolSystemViewer")]
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/BPSFrame/Editor/Windows/PoolSystem/PoolSystemViewer.uxml");
            ...
            #region 绑定编辑器事件
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnPushObject), OnPushObject);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnGetObject), OnGetObject);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnPushGameObject), OnPushGameObject);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnGetGameObject), OnGetGameObject);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string>>(nameof(OnClearnObject), OnClearnObject);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string>>(nameof(OnClearGameObject), OnClearGameObject);
            BPSFrameRoot.EditorEventModule.AddEventListener(nameof(OnClearAllObject), OnClearAllObject);
            BPSFrameRoot.EditorEventModule.AddEventListener(nameof(OnClearAllGameObject), OnClearAllGameObject);
            BPSFrameRoot.EditorEventModule.AddEventListener(nameof(OnClearAll), OnClearAll);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnInitObjectPool), OnInitObjectPool);
            BPSFrameRoot.EditorEventModule.AddEventListener<Action<string, int>>(nameof(OnInitGameObjectPool), OnInitGameObjectPool);
            #endregion
        ...
        {
            VisualTreeAsset template = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/BPSFrame/Editor/Windows/PoolSystem/PoolSystemItem.uxml");
