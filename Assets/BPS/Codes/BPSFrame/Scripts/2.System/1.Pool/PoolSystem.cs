...
namespace BPSFrame
{
    ...
    public static class PoolSystem
    {
        ...
        public static void Init()
        {
            ...
            poolRootTransform.SetParent(BPSFrameRoot.RootTransform);
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnInitGameObjectPool", keyName, defaultQuantity);
#endif
        }
        /// <summary>
        /// 初始化对象池
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnInitGameObjectPool", keyName, gameObjects.Length);
#endif
        }
...
#if UNITY_EDITOR
            if (go != null && BPSFrameRoot.EditorEventModule != null) BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnGetGameObject", keyName, 1);
#endif
            return go;
        }
...
#if UNITY_EDITOR
                if (BPSFrameRoot.EditorEventModule != null && res)
                    BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnPushGameObject", keyName, 1);
#endif
                return res;
            }
            else
            {
                BPSLog.Error("您正在将Null放置对象池");
                return false;
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string>("OnClearGameObject", keyName);
#endif
        }
        #endregion
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnInitObjectPool", keyName, defaultQuantity);
#endif
        }
        /// <summary>
        /// 初始化对象池并设置容量
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnInitObjectPool", keyName, 0);
#endif
        }
...
#if UNITY_EDITOR
            if (BPSFrameRoot.EditorEventModule != null)
                BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnInitObjectPool", type.FullName, 0);
#endif
        }
        ...
        public static object GetObject(string keyName)
        {
            ...
            {
                if (BPSFrameRoot.EditorEventModule != null)
                    BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnGetObject", keyName, 1);
            }
#endif
            return obj;
        }
        ...
        public static bool PushObject(object obj, string keyName)
        {
            ...
            else
            {
                ...
                if (BPSFrameRoot.EditorEventModule != null && res)
                {
                    BPSFrameRoot.EditorEventModule.EventTrigger<string, int>("OnPushObject", keyName, 1);
                }
#endif
                return res;
            }
        ...
        public static void ClearObject(string keyName)
        {
            ...
            if (BPSFrameRoot.EditorEventModule != null)
            {
                BPSFrameRoot.EditorEventModule.EventTrigger<string>("OnClearnObject", keyName);
            }
#endif
        ...
        public static void ClearAll(bool clearGameObject = true, bool clearCSharpObject = true)
        {
...
#if UNITY_EDITOR
                BPSFrameRoot.EditorEventModule.EventTrigger("OnClearAllGameObject");
#endif
            }
            if (clearCSharpObject)
            {
                ...
                if (BPSFrameRoot.EditorEventModule != null)
                {
                    BPSFrameRoot.EditorEventModule.EventTrigger("OnClearAllObject");
                }
#endif
            }
        }
