...
namespace BPSFrame
{
    ...
    /// 框架根节点
    /// </summary>
    public class BPSFrameRoot : MonoBehaviour
    {
        private BPSFrameRoot() { }
        private static BPSFrameRoot Instance;
        public static Transform RootTransform { get; private set; }
        public static BPSFrameSetting Setting { get => Instance.FrameSetting; }
        // 框架层面的配置文件
        [SerializeField] BPSFrameSetting FrameSetting;
        ...
        private void InitSystems()
        {
            ...
            SaveSystem.Init();
#if ENABLE_LOG
            BPSLog.Init(FrameSetting.LogConfig);
#endif
        }
        #endregion
        ...
        public static void InitForEditor()
        {
            ...
            if (Instance == null)
            {
                Instance = GameObject.FindObjectOfType<BPSFrameRoot>();
